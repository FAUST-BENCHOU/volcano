...
func TestValidateJobCreate(t *testing.T) {
	...
	testCases := []struct {
		...
		// 	...
		// },
		// Note: Tasks array validation (minItems: 1) is now enforced by CRD schema validation.
		// This test case is skipped as it is tested in e2e tests with actual CRD validation.
		// {
		// 	Name: "no-task",
		// 	...
		...
		// This test case is skipped as it is tested in e2e tests with actual CRD validation.
		// The validation that minAvailable <= total replicas remains in webhook, but it requires valid replicas values.
		// {
		...
		// 	...
		// },
		// Note: Task name format validation (DNS-1123 label) is now enforced by CRD schema validation.
		// This test case is skipped as it is tested in e2e tests with actual CRD validation.
		// {
		// 	Name: "nonDNS-task",
		// 	...
		...
		// Note: PartitionPolicy validation (PartitionSize, TotalPartitions, and replicas == TotalPartitions*PartitionSize)
		// is now enforced by CRD schema validation (XValidation).
		// This test case is skipped as it is tested in e2e tests with actual CRD validation.
		// {
		// 	Name: "PartitionSize-lessThanZero",
		// 	...
		// },
		// Note: PartitionPolicy validation is now enforced by CRD schema validation (XValidation).
		// This test case is skipped as it is tested in e2e tests with actual CRD validation.
		// {
		// 	Name: "TotalPartitions-lessThanZero",
		// 	...
		// },
		// Note: PartitionPolicy validation (replicas == TotalPartitions*PartitionSize) is now enforced by CRD schema validation (XValidation).
		// This test case is skipped as it is tested in e2e tests with actual CRD validation.
		// {
...
func TestValidateJobUpdate(t *testing.T) {
	testCases := []struct {
		...
		// Note: MinAvailable validation (>= 0) is now enforced by CRD schema validation.
		// This test case is skipped as it is tested in e2e tests with actual CRD validation.
		// {
